...
const SVG = () => {
    ...
    useEffect(() => {
        //translate(-180.59003 -163.87113)
        const int = setInterval(() => {
            // let attr = load.getAttribute('transform') || null
            const load = document.getElementById('hand')
            const head = document.getElementById('head')
            if (load){
                let attr = load.getAttribute('transform') || null
                let ar = attr.split('(')[1].replace(')','').split(' ')
                let h = head.getAttribute('transform')
                // load.removeAttribute('transform')

                if(Number(ar[0]) >= -200.59003){

                    load.setAttribute('transform', `translate(${Number(ar[0]) - 20} ${ar[1]})`)
                    // head.setAttribute('transform', `translate(${Number(ar[0]) - 20} ${ar[1]})`)
                }else {
                    load.setAttribute('transform', `translate(${Number(ar[0]) + 4} ${ar[1]})`)
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
            ...
            <path
                ...
                transform="translate(-206.59003 -163.87113)" fill="#3e3785"/>
            ...
            <path id="hand"
                  ...
                  transform="translate(-180.59003 -163.87113)" fill="#ffb6b6"/>
            <path
            ...
            <path
                ...
                transform="translate(-206.59003 -163.87113)" fill="#3e3785"/>
            <rect x="209.38454" y="260.82713" width="50.71916" height="10.8457" rx="3.26417" fill="#3e3785"/>
            ...
            <path
                ...
                transform="translate(-206.59003 -163.87113)" fill="#3f3d56"/>
            <circle
                data-name="Ellipse 5" cx="386.3965" cy="267.20052"
                    r="44.55826"
                    fill="#ffb6b6"/>
            <path
                id="head"
...
const Home = (props) => {
        ...
        return (
            <>
                <section id={'home'} className={'home-container container-xxl'} data-section={'home'}>
                    <h5 className={'secondary-text-color'}>Hello I'm</h5>
                    <h1 className={'capitalize main-text-color'}>{name}</h1>
                    <h5 className={'secondary-text-color'}>{subtitle}</h5>
                    <Cta/>
                    <div className="col-12 col-md-7 m-auto my-4">
                        <SVG/>
                        {/*<LazyLoad src={urlGet() || 'programming.svg'} file={urlGet() ? true : false}*/}
